...
export default function Description() {
  return (
    <div className="relative flex h-screen w-full items-center bg-light-gray-1 px-8">
      {/* bg */}
      <div className="absolute right-0 top-0 h-56 w-44">
        <Image
      ...
      {/* coin */}
      <div className="absolute left-20 top-44 h-10 w-10">
        <Image
          src="/coin/coin-2.png"
          alt="coin-2"
          fill={true}
      ...
      <div className="absolute right-24 top-56 h-16 w-16">
        <Image
      ...
      <div className="absolute bottom-40 left-16 h-20 w-20">
        <Image
          src="/coin/coin-9.png"
          alt="coin-2"
          fill={true}
      ...
      <div className="relative z-10">
        <h1 className="text-white-custome inline-block text-xl">What is</h1>
        <span className="ml-1 bg-light-green px-1 text-xl font-bold text-dark">
          CrypTrack
        </span>
