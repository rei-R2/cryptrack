...
export default function Feature() {
  return (
    <>
      <div className="flex h-screen w-fit items-center px-8">
        <div className="">
          <svg
          ...
          <h1 className="text-white-custome text-xl font-semibold">
      ...
      <div className="flex h-screen w-fit items-center bg-light-gray-1 px-8">
        <div className="flex flex-col items-end">
          ...
          <h1 className="text-white-custome text-end text-xl font-semibold">
      ...
      <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden px-8">
        <div className="mb-14">
          <h1 className="text-white-custome mb-5 text-center text-xl font-semibold">
            Crypto
          </h1>
...
function IconCrypto() {
  return (
    <div className="animate-marquee flex w-fit gap-x-3 px-[6px]">
